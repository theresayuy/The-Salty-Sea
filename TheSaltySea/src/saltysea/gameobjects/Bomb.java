...
public class Bomb extends GameObject implements Runnable {
    ...
    public Bomb(double x, double y, double speed, SaltySeaGUI gui, SaltySeaPanel panel) {
        ...
        lists[0] = super.loadImages(new LinkedList(), "bomb"); // bomb in stationary state
        lists[1] = super.loadImages(new LinkedList(), "bomb explodes"); // after explosion debris cloud  
    }
