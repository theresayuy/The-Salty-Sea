...
public abstract class Enemy extends GameObject implements Runnable {
    ...
    public Enemy(double x, double y, double speed, int reward, double health, int numberOfLists, SaltySeaGUI gui, SaltySeaPanel panel) {
        ...
        this.lists[lists.length - 1] = super.loadImages(new LinkedList(), "red blood"); // when most enemies die (except for squid, blood effect will be reinitiallized in squid constructor)
    }
